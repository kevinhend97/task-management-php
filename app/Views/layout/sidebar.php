<div class="c-sidebar c-sidebar-legacy c-sidebar-fixed" id="sidebar">
      <div class="c-sidebar-brand d-md-down-none">
      </div>
      <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="<?= base_url() ?>/dashboard">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-bolt"></use>
            </svg> Dashboard<span class="badge badge-info">NEW</span></a></li>
       
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="<?= base_url() ?>/assigment">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-check"></use>
            </svg> Assigment</a>
        </li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="<?= base_url('customers') ?>">
            <svg class="c-sidebar-nav-icon">
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="#">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-chart-line"></use>
            </svg> Payment</a>
        </li>
      </ul>
